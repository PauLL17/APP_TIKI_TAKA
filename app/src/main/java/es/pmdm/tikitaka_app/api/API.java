...
public class API {
    ...
    // NOTICIAS
    public static void getNoticias(String token, UtilREST.OnResponseListener listener) {
        UtilREST.runQuery(UtilREST.QueryType.GET, BASE_URL + "api/noticias", null, token, listener);
    }
